...
%let taqms_libpath = /wrds/nyse/sasdata/taqms/ct; * specify millisecond TAQ trade data library;
libname taqms "&taqms_libpath.";
%let taq_ds=taqms.ctm_2019:;     * data set you are interested;
* Note: for all daily files in a pariticular month, say November 2019, you can use 'ctm_201911:';
...
%let interval_seconds =60;    * interval is 60 seconds (1 minute);
