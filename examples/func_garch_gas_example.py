...
fGAS_likelihood = lambda vtheta: gas_garch_estimator(mY, vb0, dK, n, mBsplinesSparseMat, vtheta)[0]
optim_GAS = minimize(
...
mVolatilityHat_GAS = gas_garch_estimator(mY, vb0, dK, n, mBsplinesSparseMat, vthetaHat_GAS)[1]
...
fGARCH_likelihood = lambda vtheta: func_garch_estimator(mY, mBsplinesSparseMat, vtheta, M)[0]
...
mVolatilityHat_GARCH = func_garch_estimator(mY, mBsplinesSparseMat, vthetaHat_GARCH, M)[1]
